...
data_dir = os.path.join(data_path, "instagram")
...
def get_graph_data(account, set_range, set_length):
    ...
    for data_date in chosen_data:
        ...
        name = value["name"]
        post_value = int(value["stats"]["post_value"])
    ...
    for data_date in chosen_data:
        ...
        for prev, prev_value in data.items():
            ...
            if start_time <= time:
                ...
                date = prev
                past_post_value = int(prev_value["stats"]["post_value"])
...
def get_difference(account, set_range, set_length):
    ...
    for t in prev_time:
        ...
        past_post_value = int(prev_time[t]["stats"]["post_value"])
